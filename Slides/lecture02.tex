...
\begin{itemize}
\item Can be problematic for same reasons as long texts
\item Best practices
	\begin{itemize}
	\item Keep it short
...
\item<2->Examples
	\begin{itemize}
	\item Audio: Sound of different voices saying the same sentence
	\item Video: Advertisments\footnote{Vavreck. 2007 ``The Exaggerated Effects of Advertising on Turnout: The Dangers of Self-Reports.'' \textit{Quarterly Journal of Political Science} 2: 325--343.}
	\end{itemize}	
\end{itemize}
...
\item Use a two- (or more-) wave panel to measure duration of effects
	...
	\end{itemize}
\item Two main concerns (non unique to survey experiments)
	\begin{itemize}
	\item Attrition
...
\frametitle{{\normalsize Within-Subjects Designs}}
...
\frametitle{{\normalsize Randomized Field Treatment}}
...
\frametitle{{\normalsize Treatment Encouragement}}
...
\frametitle{Treatment Noncompliance}

\begin{itemize}
\item More on this Friday
\item Quick preview today
