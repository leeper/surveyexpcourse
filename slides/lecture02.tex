...
\item<2-> Examples
	\begin{itemize}\footnotesize
	\item<2-> Kalmoe \& Gross\footnote{2016. ``Cueing Patriotism, Prejudice, and Partisanship in the Age of Obama: Experimental Tests of U.S. Flag Imagery Effects in Presidential Elections.'' \textit{Political Psychology}.} measure impact of patriotic cues on candidate support by showing images of candidates with and without flags
...
\frametitle{Example\footnote{Kalmoe \& Gross. 2016. ``Cueing Patriotism, Prejudice, and Partisanship in the Age of Obama: Experimental Tests of U.S. Flag Imagery Effects in Presidential Elections.'' \textit{Political Psychology}.}}


\begin{center}
\includegraphics[width=\textwidth]{images/KalmoeGross1}

\vspace{1em}

\includegraphics[width=.8\textwidth]{images/KalmoeGross2}
...
Now I'm going to read you three things that sometimes make people angry or upset. After I read all \only<1>{three}\only<2>{four}, just tell me \textit{how many} of them upset you. I don't want to know which ones. just \textit{how many}.
...
\end{quote}
\onslide<2->{\small\hspace{5em} --Thomas J. Leeper (6 July 2017)}
